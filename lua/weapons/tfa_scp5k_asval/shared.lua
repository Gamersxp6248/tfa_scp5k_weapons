...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/asval/v_asval.mdl" 
SWEP.ViewModelFOV			= 80		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(0, 2, 0.75)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/asval/w_asval.mdl" 
SWEP.Bodygroups_W = {
...
SWEP.RunSightsAng      = Vector(-25, 30, 0)
...
SWEP.IronSightsPos     = Vector(-2.37, -0, 1.66)
SWEP.IronSightsAng     = Vector(0.55, -0.1, 0)
...
SWEP.PrintName			= "ASVAL"		         -- Weapon name (Shown on HUD)
SWEP.Manufacturer		= "TsNIITochMash"
...
-------------------------- Fire Handling
SWEP.Primary.RPM_Displayed         = 923         -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM                   = 923         -- This is in Rounds Per Minute / RPM
...
SWEP.Primary.SpreadMultiplierMax                 = 3.25 --How far the spread can expand when you shoot. Example val: 2.5
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_ASVAL_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_FIREMODE] = {
		{time = 0 / 30, type = "sound", value = Sound("Weapon_ASVAL_Firemode")}
	},
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_ASVAL_MagPouchDown")},
		{time = 25 / 60, type = "sound", value = Sound("Weapon_ASVAL_MagOut")},
		--{time = 45 / 60, type = "sound", value = Sound("Weapon_MK18_MagHit")},
		{time = 58 / 60, type = "sound", value = Sound("Weapon_ASVAL_MagIn")},
		{time = 91 / 60, type = "sound", value = Sound("Weapon_ASVAL_MagPouchUp")},
		{time = 125 / 60, type = "sound", value = Sound("Weapon_ASVAL_HandlingBarrel")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_ASVAL_EmptyMagPouch")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_ASVAL_EmptyMagOut")},
		{time = 47 / 60, type = "sound", value = Sound("Weapon_ASVAL_EmptyMagIn")},
		{time = 105 / 60, type = "sound", value = Sound("Weapon_ASVAL_EmptyBoltBack")},
		{time = 115 / 60, type = "sound", value = Sound("Weapon_ASVAL_EmptyBoltForward")},
		{time = 130 / 60, type = "sound", value = Sound("Weapon_ASVAL_HandlingBarrel")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_ASVAL_InspectRotate")},
		{time = 72 / 60, type = "sound", value = Sound("Weapon_ASVAL_BoltBack")},
		{time = 151 / 60, type = "sound", value = Sound("Weapon_ASVAL_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_ASVAL_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 20 / 60, type = "sound", value = Sound("Weapon_ASVAL_MagCheckIn")},
...
local modrail_s_pos = Vector(0, -0.75, 1.5)
local modrail_ua_pos = Vector(0, -10.1, -0.5)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.9, -10.1, 0.25)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.9, -10.1, 0.25)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, -6.5, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
