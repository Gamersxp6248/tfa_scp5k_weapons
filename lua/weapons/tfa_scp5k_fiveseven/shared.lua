...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/fiveseven/v_fiveseven.mdl" 
SWEP.ViewModelFOV			= 65		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-3.0, -2.5, 1.25)+Vector(2,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/fiveseven/w_fiveseven.mdl" 
SWEP.Bodygroups_W = {
...
SWEP.Manufacturer		= "FN Herstal Belgium"
...
SWEP.Attachments = {
	[1] = { atts = { "ck_hornet", "ck_hornetb", "ck_bigiron_pistol", "ck_twofang", "ck_beltfed", "ck_jakobs" } },
...
local SightsOffsetThingy = Vector(-0.44,-6,1.6775)
local SightsOffsetThingyButForAngles = Vector(-0.275,0.0925,0)
