...
SWEP.VMPos                  = Vector(0.05, -0.5, 1.85)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
local SightsOffsetThingy = Vector(0.43,0,0.53)
local SightsOffsetThingyButForAngles = Vector(-0.22,0.02,0)
...
local modrail_s_pos = Vector(0, -4, 3.5)
local modrail_ua_pos = Vector(0, -8.25, -2)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.775, -2, 2.45)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.8, -2, 2.45)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0.15, 4.5, -0.375), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
