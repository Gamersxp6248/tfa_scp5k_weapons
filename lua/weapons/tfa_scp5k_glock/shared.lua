...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/glock/v_glock.mdl" 
SWEP.ViewModelFOV			= 75		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-2.5, -4, 0.5)+Vector(2,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.IronSightsPos     = Vector(-2.43, 0.5, 2.3)
...
SWEP.PrintName			= "Glock 20"		         -- Weapon name (Shown on HUD)
...
local SightsOffsetThingy = Vector(0.0085,-6,1.1575)
local SightsOffsetThingyButForAngles = Vector(-0.18,-0.6,0)
...
local modrail_s_pos = Vector(0, 1, 2.2)
local modrail_ua_pos = Vector(0, -1, 0.4)
local modrail_ug_pos = Vector(0, -2, -0.1)
local modrail_la_pos = Vector(-0.6, -1, 1)
local modrail_lg_pos = Vector(-0.1, -2, 0)
local modrail_ra_pos = Vector(0.6, -1, 1)
