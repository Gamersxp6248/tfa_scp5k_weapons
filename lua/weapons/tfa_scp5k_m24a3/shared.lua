...
local SightsOffsetThingy = Vector(-1.3725,0,1.1)
local SightsOffsetThingyButForAngles = Vector(-0.27,0,0)
...
local modrail_s_pos = Vector(0, 0, 1.725)
local modrail_ua_pos = Vector(0, -12.5, -0.65)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.9, -12.5, 0.25)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.9, -12.5, 0.25)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrelattach", rel = "", pos = Vector(0, 1.25, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
