...
SWEP.VMPos                  = Vector(-0.25, -0.0, 0.5)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
local SightsOffsetThingy = Vector(-0.4,0,1.15)
local SightsOffsetThingyButForAngles = Vector(-0.32,0.08,0)
...
local modrail_s_pos = Vector(0, 1.5, 1.275)
local modrail_ua_pos = Vector(0, -7.25, -2.2)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.95, -7.25, -0.8)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.95, -7.25, 0.8)
