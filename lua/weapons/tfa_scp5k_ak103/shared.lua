...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/ak103/v_ak103.mdl" 
SWEP.ViewModelFOV			= 80		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-0.25, 0, 0)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/ak103/w_ak103.mdl" 
SWEP.Bodygroups_W = {
...
-------------------------- VM Positions
SWEP.RunSightsPos      = Vector(-3, -4, -3)
...
SWEP.IronSightsPos     = Vector(-2.415, -0.75, 0.6)
SWEP.IronSightsAng     = Vector(0.4, -0.03, 0)
SWEP.IronSightTime     = 0.2 

SWEP.InspectPos        = Vector(-1, -3.0, -1.0)
SWEP.InspectAng        = Vector(15, 5, -5)

--------------------------------------------------- Hud Elements
SWEP.SubCategory        = "Assault Rifles"
SWEP.PrintName			= "AK-103"		         -- Weapon name (Shown on HUD)
...
SWEP.Primary.Ammo              = "tfa_scp5k_m0_c2"        --pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun.
...
SWEP.Primary.RangeFalloff          = 0.75           -- Set to 0.8, for example, to start falling off after 80% of the range.
...
SWEP.Primary.StaticRecoilFactor    = .55
...
-------------------------- Spread
SWEP.Primary.Spread                = 0.040--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.Primary.SpreadRecovery        = 3.75 --How much the spread recovers, per second. Example val: 3
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_AK103_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK103_MagStart")},
		{time = 20 / 60, type = "sound", value = Sound("Weapon_AK103_MagOut")},
		{time = 30 / 60, type = "sound", value = Sound("Weapon_AK103_MagPouchDown")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_AK103_MagPouchUp")},
		{time = 105 / 60, type = "sound", value = Sound("Weapon_AK103_MagIn")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK103_EmptyStart")},
		{time = 5 / 60, type = "sound", value = Sound("Weapon_AK103_EmptyMagPouchUp")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_AK103_EmptyMagOut")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_AK103_EmptyMagIn")},
		{time = 92 / 60, type = "sound", value = Sound("Weapon_AK103_EmptyBolt")},
		{time = 160 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyMagPouch")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK103_InspectRotate")},
		{time = 127 / 60, type = "sound", value = Sound("Weapon_AK103_BoltBack")},
		{time = 165 / 60, type = "sound", value = Sound("Weapon_AK103_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK103_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 61 / 60, type = "sound", value = Sound("Weapon_AK103_MagCheckIn")},	
	},
}
...
SWEP.IronSightsPos_Kobra  = Vector(-2.4195, -0.75, -0.37)
SWEP.IronSightsAng_Kobra  = Vector(0.475, -0.061, 0)

SWEP.IronSightsPos_EOTech     = Vector(-2.4195, -0.75, -0.6)
SWEP.IronSightsAng_EOTech     = Vector(0.475, -0.061, 0)

SWEP.IronSightsPos_RDS     = Vector(-2.4195, -0.75, -0.575)
SWEP.IronSightsAng_RDS     = Vector(0.475, -0.061, 0)

SWEP.IronSightsPos_2XRDS     = Vector(-2.41, -0.75, -0.645)
SWEP.IronSightsAng_2XRDS     = Vector(0.575, -0.061, 0)
SWEP.RTScopeFOV_2XRDS        = 45 -- Why do we have to define this???

SWEP.IronSightsPos_C79     = Vector(-2.41, -0.75, -0.825)
SWEP.IronSightsAng_C79     = Vector(0.575, -0.061, 0)
SWEP.RTScopeFOV_C79        = 45

SWEP.IronSightsPos_PO4X     = Vector(-2.35, -0.75, -0.325)
SWEP.IronSightsAng_PO4X     = Vector(0.575, -0.061, 0)
SWEP.RTScopeFOV_PO4X        = 45

SWEP.IronSightsPos_Mosin     = Vector(-2.39, 0.75, -0.1)
SWEP.IronSightsAng_Mosin     = Vector(0.575, -0.0425, 0)
SWEP.RTScopeFOV_Mosin       = 45

SWEP.IronSightsPos_MX4     = Vector(-2.42, 1, -0.83)
SWEP.IronSightsAng_MX4      = Vector(0.475, -0.06, 0)
...
local modrail_s_pos = Vector(0, -0.75, 2.1)
local modrail_ua_pos = Vector(0, -10.1, -0.4)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.9, -10.1, 0.6)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.9, -10.1, 0.6)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, -0.05, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
