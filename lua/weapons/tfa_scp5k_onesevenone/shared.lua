...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/onesevenone/v_onesevenone.mdl" 
SWEP.ViewModelFOV			= 65		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-3.0, -2.5, 1.25)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
SWEP.VMAng                  = Vector(1, -0.0, -10)    --The viewmodel angular offset, constantly.   Subtract this from any other modifications to viewmodel angle.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/onesevenone/w_onesevenone.mdl" 
SWEP.Bodygroups_W = {

}
SWEP.HoldType               = "revolver" -- melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive
SWEP.Offset = {
	Pos = {
		Up = -1.75,
		Right = 1.5,
...
SWEP.PrintName			= "One-seveN-One"		         -- Weapon name (Shown on HUD)
SWEP.Manufacturer		= "You're a monster, you know that?"
...
-------------------------- Visual Recoil
SWEP.ViewModelPunchPitchMultiplier               = 3.0 -- Default value is 0.5
SWEP.ViewModelPunchPitchMultiplier_IronSights    = 1.5 -- Default value is 0.09

SWEP.ViewModelPunch_MaxVertialOffset             = 3 -- Default value is 3
SWEP.ViewModelPunch_MaxVertialOffset_IronSights  = 4.5 -- Default value is 1.95
SWEP.ViewModelPunch_VertialMultiplier            = 1.5 -- Default value is 1
SWEP.ViewModelPunch_VertialMultiplier_IronSights = 1.5 -- Default value is 0.25

SWEP.ViewModelPunchYawMultiplier                 = 3 -- Default value is 0.45
SWEP.ViewModelPunchYawMultiplier_IronSights      = 3 -- Default value is 1.5
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_FiveSeveN_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		...
		{time = 0 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagPouchDown")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagOut")},
		{time = 65 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagIn")},
		{time = 88 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagPouchUp")},
		{time = 100 / 30, type = "sound", value = Sound("Generic_ClothEquip")}
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_EmptyMagOut")},
		{time = 25 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagPouchDown")},
		{time = 50 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_EmptyMagIn")},
		{time = 105 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_EmptyBolt")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_InspectRotate")},
		{time = 130 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_BoltBack")},
		{time = 170 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_BoltForward")},
		{time = 197 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_BoltHit")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 16 / 60, type = "sound", value = Sound("Weapon_FiveSeveN_MagCheckIn")},		
	},
}
...
SWEP.Attachments = {
	--[1] = { atts = { "ck_hornet", "ck_hornetb", "ck_bigiron", "ck_twofang", "ck_beltfed" } },
	...
	--[6] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight", "ins2_fg_grip", "ins2_fg_bipod_ub" } },
	--[6] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight" } },
	--[7] = { atts = { "ins2_fg_grip", "ins2_fg_bipod_ub" } },
...
SWEP.IronSightsPos_Kobra  = Vector(-2.77, -0.75, 1.87)
SWEP.IronSightsAng_Kobra  = Vector(0, -0.05, 0)

SWEP.IronSightsPos_EOTech     = Vector(-2.77, -0.75, 1.77) --Vector(-2.79, 0.5, 0.88)
SWEP.IronSightsAng_EOTech     = Vector(0, 0.02, 0)

SWEP.IronSightsPos_RDS     = Vector(-2.77, -0.75, 1.77)
SWEP.IronSightsAng_RDS     = Vector(0, 0.02, 0)

SWEP.IronSightsPos_2XRDS     = Vector(-2.77, -8, 1.77)
SWEP.IronSightsAng_2XRDS     = Vector(0, 0.02, 0)
SWEP.RTScopeFOV_2XRDS        = 25 -- Why do we have to define this???

SWEP.IronSightsPos_C79     = Vector(-2.77, -8, 1.59)
SWEP.IronSightsAng_C79     = Vector(0, 0.02, 0)
SWEP.RTScopeFOV_C79        = 25

SWEP.IronSightsPos_PO4X     = Vector(-2.77, -8.5, 1.89)
SWEP.IronSightsAng_PO4X     = Vector(0, 0.02, 0)
SWEP.RTScopeFOV_PO4X        = 25

SWEP.IronSightsPos_Mosin     = Vector(-2.77, -8.5, 2.02)
SWEP.IronSightsAng_Mosin     = Vector(0, 0.02, 0)
SWEP.RTScopeFOV_Mosin       = 25

SWEP.IronSightsPos_MX4     = Vector(-2.77, -8.5, 1.64)
SWEP.IronSightsAng_MX4      = Vector(0, 0.02, 0)
SWEP.RTScopeFOV_MX4        = 25

SWEP.ViewModelBoneMods = {
	--["b_wpn_muzzle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -90) },
}

local modrail_s_pos = Vector(0, 2, 2.4)
local modrail_ua_pos = Vector(0, -1.5, 0.4)
local modrail_ug_pos = Vector(0, -2, -0.1)
local modrail_la_pos = Vector(-0.8, -1.5, 1)
local modrail_lg_pos = Vector(-0.1, -2, 0)
local modrail_ra_pos = Vector(0.8, -1.5, 1)
local modrail_s_bone = "Weapon"
local modrail_ub_bone = "Weapon"
local modrail_s_scale = 1

SWEP.VElements = {
	["modrail"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_mount_galil.mdl", bone = modrail_s_bone, rel = "", pos = modrail_s_pos + Vector(0,-1,-0.3), angle = Angle(0, 90, 0), size = Vector(0.5, 0.6, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["sight_rds"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_aimpoint.mdl", bone = modrail_s_bone, rel = "", pos = modrail_s_pos + Vector(0, 0.25, 0.2), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrelattach", rel = "", pos = Vector(0, -0.05, 0), angle = Angle(0, 90, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
