...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/mp5k/v_mp5k.mdl" 
SWEP.ViewModelFOV			= 75		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-1, -1, 1)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/mp5k/w_mp5k.mdl" 
SWEP.Bodygroups_W = {

}
SWEP.HoldType               = "smg" -- melee melee2 fist knife smg ar2 pistol rpg physgun grenade shotgun crossbow slam passive
SWEP.Offset = {
	Pos = {
		Up = -3.35,
		Right = 1.5,
...
SWEP.IronSightsPos     = Vector(-2.835, -0.0, 1.67)
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_MP5K_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MP5K_MagOut")},
		{time = 25 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagPouch")},
		{time = 40 / 60, type = "sound", value = Sound("Weapon_MP5K_Rotate")},
		--{time = 45 / 60, type = "sound", value = Sound("Weapon_MK18_MagHit")},
		{time = 130 / 60, type = "sound", value = Sound("Weapon_MP5K_MagIn")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MP5SD_BoltBackEmpty")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagOutEmpty")},
		{time = 80 / 60, type = "sound", value = Sound("Weapon_MP5_MagPouchEmpty")},
		{time = 85 / 60, type = "sound", value = Sound("Weapon_MP5K_Rotate")},
		{time = 135 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagInEmpty")},
		{time = 200 / 60, type = "sound", value = Sound("Weapon_MP5SD_BoltForwardEmpty")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MP5K_Rotate")},
		{time = 150 / 60, type = "sound", value = Sound("Weapon_MP5K_BoltBack")},
		{time = 205 / 60, type = "sound", value = Sound("Weapon_MP5K_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MP5K_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 20 / 60, type = "sound", value = Sound("Weapon_MP5K_MagCheckIn")},	
	},
}
...
local SightsOffsetThingy = Vector(-0.475,0,0.55)
local SightsOffsetThingyButForAngles = Vector(-0.5,-0.08,0)
...
local modrail_ua_pos = Vector(0, -4.25, 0.65)
local modrail_ug_pos = Vector(0, -2, -0.1)
local modrail_la_pos = Vector(-0.9, -4.25, 1.50)
local modrail_lg_pos = Vector(-0.1, -2, 0)
local modrail_ra_pos = Vector(0.9, -4.25, 1.50)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, 3.5, 1), angle = Angle(0, 90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
