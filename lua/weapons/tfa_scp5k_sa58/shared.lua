...
SWEP.VMPos                  = Vector(-0, 1.0, 1.2)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
local SightsOffsetThingy = Vector(0.74,0,0.96)
local SightsOffsetThingyButForAngles = Vector(-0.18,0.04,0)
...
local modrail_s_pos = Vector(0, -1, 1.7)
local modrail_ua_pos = Vector(0, -10.25, -0.1)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.8, -10.25, 0.8)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.8, -10.25, 0.8)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, -0.5, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
