...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/ak74m/v_ak74m.mdl" 
...
SWEP.PrintName			= "AK-47M"		         -- Weapon name (Shown on HUD)
...
-------------------------- Fire Handling
SWEP.Primary.RPM_Displayed         = 666         -- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM                   = 666         -- This is in Rounds Per Minute / RPM
...
-------------------------- Recoil
SWEP.Primary.KickUp                = 0.260 -- This is the maximum upwards recoil (rise)
...
SWEP.Primary.StaticRecoilFactor    = .35
...
-------------------------- Spread
SWEP.Primary.Spread                = 0.030--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_AK74M_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		...
		{time = 20 / 60, type = "sound", value = Sound("Weapon_AK74M_MagOut")},
		{time = 30 / 60, type = "sound", value = Sound("Weapon_AK74M_MagPouchDown")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_AK74M_MagPouchUp")},
		{time = 105 / 60, type = "sound", value = Sound("Weapon_AK74M_MagIn")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK74M_EmptyStart")},
		{time = 5 / 60, type = "sound", value = Sound("Weapon_AK74M_EmptyMagPouchDown")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_AK74M_EmptyMagOut")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_AK74M_EmptyMagIn")},
		{time = 92 / 60, type = "sound", value = Sound("Weapon_AK74M_EmptyBolt")},
		{time = 160 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyMagPouch")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK74M_InspectRotate")},
		{time = 127 / 60, type = "sound", value = Sound("Weapon_AK74M_BoltBack")},
		{time = 165 / 60, type = "sound", value = Sound("Weapon_AK74M_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 1 / 60, type = "sound", value = Sound("Weapon_AK74M_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 61 / 60, type = "sound", value = Sound("Weapon_AK74M_MagCheckIn")},	
	},
}
