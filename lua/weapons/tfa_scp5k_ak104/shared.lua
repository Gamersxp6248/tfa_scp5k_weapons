...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/ak104/v_ak104.mdl" 
...
SWEP.PrintName			= "AK-104"		         -- Weapon name (Shown on HUD)
...
-------------------------- Recoil
SWEP.Primary.KickUp                = 0.270 -- This is the maximum upwards recoil (rise)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, 2.5, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
