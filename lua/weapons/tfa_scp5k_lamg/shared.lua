...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/lamg/v_lamg.mdl" 
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/lamg/w_lamg.mdl" 
SWEP.Bodygroups_W = {
...
-------------------------- VM Positions
SWEP.RunSightsPos      = Vector(0, -5, 0)
SWEP.RunSightsAng      = Vector(-15, 40, 0)
...
SWEP.IronSightsPos     = Vector(-2.47, -1, 0.88)
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_LAMG_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverUp")},
		{time = 30 / 60, type = "sound", value = Sound("Weapon_LAMG_InspectBeltOut")},
		{time = 125 / 60, type = "sound", value = Sound("Weapon_LAMG_MagOut")},
		{time = 160 / 60, type = "sound", value = Sound("Weapon_LAMG_MagPouch")},
		{time = 220 / 60, type = "sound", value = Sound("Weapon_LAMG_MagIn")},
		{time = 300 / 60, type = "sound", value = Sound("Weapon_LAMG_BeltIn")},
		{time = 370 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverDown")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_LAMG_EmptyBoltBackForward")},
		{time = 35 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverUp")},
		{time = 115 / 60, type = "sound", value = Sound("Weapon_LAMG_EmptyMagOut")},
		{time = 160 / 60, type = "sound", value = Sound("Weapon_LAMG_EmptyMagPouch")},
		{time = 230 / 60, type = "sound", value = Sound("Weapon_LAMG_EmptyMagIn")}, 
		{time = 280 / 60, type = "sound", value = Sound("Weapon_LAMG_EmptyBeltIn")},
		{time = 380 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverDown")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_LAMG_Rotate")},
		{time = 140 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverUp")},
		{time = 165 / 60, type = "sound", value = Sound("Weapon_LAMG_InspectBeltOut")},
		{time = 250 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverOpen")},
		{time = 305 / 60, type = "sound", value = Sound("Weapon_LAMG_BoltCooking")},
		{time = 320 / 60, type = "sound", value = Sound("Weapon_LAMG_BoltBack")},
		{time = 420 / 60, type = "sound", value = Sound("Weapon_LAMG_CoverClose")},
		{time = 460 / 60, type = "sound", value = Sound("Weapon_LAMG_BeltIn")},
...
SWEP.StatusLengthOverride   = {
	[ACT_VM_RELOAD] = 130 / 30,
    [ACT_VM_RELOAD_EMPTY] = 140 / 30,		
}
