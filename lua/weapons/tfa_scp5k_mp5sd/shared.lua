...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/mp5sd/v_mp5sd.mdl" 
SWEP.ViewModelFOV			= 80		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-1, -0.0, 1)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/mp5sd/w_mp5sd.mdl" 
SWEP.Bodygroups_W = {
...
SWEP.PrintName			= "MP5-SD"		         -- Weapon name (Shown on HUD)
...
-------------------------- Spread
SWEP.Primary.Spread                              = .0085 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.Primary.SpreadIncrement                     = 0.1 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_MP5SD_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagOut")},
		{time = 12 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagPouch")},
		--{time = 45 / 60, type = "sound", value = Sound("Weapon_MK18_MagHit")},
		{time = 100 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagIn")},
		{time = 140 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagHit")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		...
		{time = 115 / 60, type = "sound", value = Sound("Weapon_MP5SD_MagInEmpty")},
		{time = 165 / 60, type = "sound", value = Sound("Weapon_MP5SD_BoltForwardEmpty")},
	},
	[ACT_VM_FIDGET] = {
...
local SightsOffsetThingy = Vector(-0.525,0,0.615)
local SightsOffsetThingyButForAngles = Vector(-0.38,-0.20,0)
...
local modrail_ua_pos = Vector(0, -8.25, 0.1)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-1.2, -8.25, 1.35)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(1.2, -8.25, 1.35)
