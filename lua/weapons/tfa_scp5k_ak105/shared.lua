...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/ak105/v_ak105.mdl" 
...
SWEP.PrintName			= "AK-105"		         -- Weapon name (Shown on HUD)
...
-------------------------- Recoil
SWEP.Primary.KickUp                = 0.100 -- This is the maximum upwards recoil (rise)
...
SWEP.Primary.StaticRecoilFactor    = .5
...
SWEP.EventTable = {
	...
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_AK74M_MagCheckOut")},
