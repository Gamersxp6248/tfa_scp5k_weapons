...
local SightsOffsetThingy = Vector(-0.51,0,0.65)
...
local modrail_ua_pos = Vector(0, -6.25, 0.65)
local modrail_ug_pos = Vector(0, -2, -0.1)
local modrail_la_pos = Vector(-0.9, -6.25, 1.50)
local modrail_lg_pos = Vector(-0.1, -2, 0)
local modrail_ra_pos = Vector(0.9, -6.25, 1.50)
