...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/1911/v_1911.mdl" 
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/1911/w_1911.mdl" 
SWEP.Bodygroups_W = {
...
SWEP.Primary.RangeFalloff          = 0.55           -- Set to 0.8, for example, to start falling off after 80% of the range.
...
-------------------------- Spread
SWEP.Primary.Spread                              = 0.04 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_1911_Fire")
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
		{time = 0 / 30, type = "sound", value = Sound("Weapon_1911_Equip")},
		{time = 0 / 30, type = "sound", value = Sound("Generic_ClothEquip")}
	},
	[ACT_VM_HOLSTER] = {
		{time = 0 / 30, type = "sound", value = Sound("Weapon_1911_Unequip")},
		{time = 0 / 30, type = "sound", value = Sound("Generic_ClothUnequip")}
	},
	[ACT_VM_RELOAD] = {
	    {time = 0 / 60, type = "sound", value = Sound("Weapon_1911_Start")},
		{time = 0 / 60, type = "sound", value = Sound("Weapon_1911_MagPouchDown")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_1911_MagOut")},
		{time = 56 / 60, type = "sound", value = Sound("Weapon_1911_MagIn")},
		{time = 88 / 60, type = "sound", value = Sound("Weapon_1911_MagPouchUp")},
		{time = 95 / 30, type = "sound", value = Sound("Weapon_1911_HandlingBarrel")}
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_1911_EmptyMagOut")},
		{time = 0 / 60, type = "sound", value = Sound("Weapon_1911_HandlingBarrel")},
		{time = 25 / 60, type = "sound", value = Sound("Weapon_1911_EmptyMagPouchDown")},
		{time = 50 / 60, type = "sound", value = Sound("Weapon_1911_EmptyMagIn")},
		{time = 86 / 60, type = "sound", value = Sound("Weapon_1911_EmptyBolt")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_1911_InspectRotate")},
		{time = 120 / 60, type = "sound", value = Sound("Weapon_1911_BoltBack")},
		{time = 170 / 60, type = "sound", value = Sound("Weapon_1911_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_1911_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 16 / 60, type = "sound", value = Sound("Weapon_1911_MagCheckIn")},		
	},
}
...
local SightsOffsetThingy = Vector(-0.455,-6,0.8)
local SightsOffsetThingyButForAngles = Vector(-0.225,0.11,0)
...
local modrail_s_pos = Vector(0, -1, 2.4)
local modrail_ua_pos = Vector(0, -2.0, 0.8)
local modrail_ug_pos = Vector(0, -2, -0.1)
local modrail_la_pos = Vector(-0.4, -2, 1)
local modrail_lg_pos = Vector(-0.1, -2, 0)
local modrail_ra_pos = Vector(0.4, -2, 1)
...
SWEP.AttachmentTableOverride    = {
	...
	["ins2_fg_bipod"] = { ["VElements"] = { ["modrail_ua"] = { ["active"] = true }, }, },
	-- ''Left''barrels
