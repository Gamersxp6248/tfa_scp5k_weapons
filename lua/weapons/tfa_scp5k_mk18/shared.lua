...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/mk18/v_mk18.mdl" 
...
SWEP.RunSightsAng      = Vector(-30, 30, 0)
...
SWEP.IronSightsPos     = Vector(-2.133, -0, 0.32)
...
SWEP.PrintName			= "MK 18"		         -- Weapon name (Shown on HUD)
SWEP.Manufacturer		= "Colt Defense & Daniel Defense"
...
SWEP.Primary.KickDown              = 0.09       -- This is the maximum downwards recoil (skeet)
SWEP.Primary.KickHorizontal        = 0.10      -- This is the maximum sideways recoil (no real term)
SWEP.Primary.StaticRecoilFactor    = 0.1       --Amount of recoil to directly apply to EyeAngles.  Enter what fraction or percentage (in decimal form) you want.
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_MK18_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MK18_MagPouch")},
		{time = 25 / 60, type = "sound", value = Sound("Weapon_MK18_MagOut")},
		--{time = 45 / 60, type = "sound", value = Sound("Weapon_MK18_MagHit")},
		{time = 70 / 60, type = "sound", value = Sound("Weapon_MK18_MagIn")},
		{time = 120 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyMagPouch")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyMagOut")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_MK18_MagPouch")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyMagIn")},
		{time = 120 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyBolt")},
		{time = 160 / 60, type = "sound", value = Sound("Weapon_MK18_EmptyMagPouch")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_MK18_InspectRotate")},
		{time = 140 / 60, type = "sound", value = Sound("Weapon_MK18_BoltBack")},
		{time = 190 / 60, type = "sound", value = Sound("Weapon_MK18_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
...
local SightsOffsetThingy = Vector(0.2375,0,0.185)
local SightsOffsetThingyButForAngles = Vector(-0.35,-0.295,0)
...
SWEP.ViewModelBoneMods = {
	["frontsight"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 0, -90) },
	["rearsight"] = { scale = Vector(0.02, 0.02, 0.02), pos = Vector(0, 0, 0), angle = Angle(0, 0, -90) },
}

local modrail_s_pos = Vector(0, -3.5, -0.375)
local modrail_ua_pos = Vector(0, 1, -2.25)
local modrail_ug_pos = Vector(0, 1.5, -0.1)
local modrail_la_pos = Vector(-0.9, 1, -1.5)
local modrail_lg_pos = Vector(-0.1, 1.5, 0)
local modrail_ra_pos = Vector(0.9, 1, -1.5)
local modrail_s_bone = "rearsight"
local modrail_ub_bone = "frontsight"
...
SWEP.VElements = {
	...
	["modrail_ua"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_modkit_4.mdl", bone = modrail_ub_bone, rel = "", pos = modrail_ua_pos, angle = Angle(0, 90, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["modrail_la"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_modkit_4.mdl", bone = modrail_ub_bone, rel = "", pos = modrail_la_pos, angle = Angle(0, 90, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	["modrail_ra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/w_modkit_4.mdl", bone = modrail_ub_bone, rel = "", pos = modrail_ra_pos, angle = Angle(0, 90, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, 1.25, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
