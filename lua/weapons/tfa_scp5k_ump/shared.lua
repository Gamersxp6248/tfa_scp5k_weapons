...
--------------------------------------------------- Viewmodel
SWEP.ViewModel			    = "models/weapons/tfa_scp5k/ump/v_ump.mdl" 
SWEP.ViewModelFOV			= 75		         -- This controls how big the viewmodel looks.  Less is more.
SWEP.ViewModelFlip			= false		         -- Set this to true for CSS models, or false for everything else (with a righthanded viewmodel.)
SWEP.UseHands               = true               --Use gmod c_arms system.
SWEP.VMPos                  = Vector(-1, 0, 1)+Vector(1,-2,-2)    --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
--------------------------------------------------- Worldmodel
SWEP.WorldModel			    = "models/weapons/tfa_scp5k/ump/w_ump.mdl" 
SWEP.Bodygroups_W = {
...
SWEP.IronSightsPos     = Vector(-2.505, -0.0, 2.12)
...
-------------------------- Recoil
SWEP.Primary.KickUp                = 0.140 -- This is the maximum upwards recoil (rise)
...
-------------------------- Spread
SWEP.Primary.Spread                              = .0250 --This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
--------------------------------------------------- Sounds
SWEP.Primary.Sound             = Sound("Weapon_UMP_Fire")
...
SWEP.EventTable = {
	...
	[ACT_VM_RELOAD] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_UMP_MagStart")},
		{time = 12 / 60, type = "sound", value = Sound("Weapon_UMP_MagPouchDown")},
		{time = 40 / 60, type = "sound", value = Sound("Weapon_UMP_MagOut")},
		{time = 80 / 60, type = "sound", value = Sound("Weapon_UMP_MagIn")},
		{time = 115 / 60, type = "sound", value = Sound("Weapon_UMP_MagPouchUp")},
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_UMP_EmptyStart")},
		{time = 15 / 60, type = "sound", value = Sound("Weapon_UMP_MagPouchUp")},
		{time = 45 / 60, type = "sound", value = Sound("Weapon_UMP_MagOutEmpty")},
		{time = 90 / 60, type = "sound", value = Sound("Weapon_UMP_MagInEmpty")},
		{time = 132 / 60, type = "sound", value = Sound("Weapon_UMP_BoltEmpty")},
	},
	[ACT_VM_FIDGET] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_UMP_Rotate")},
		{time = 155 / 60, type = "sound", value = Sound("Weapon_UMP_BoltBack")},
		{time = 225 / 60, type = "sound", value = Sound("Weapon_UMP_BoltForward")},
	},
	[ACT_VM_MISSCENTER] = {
		{time = 0 / 60, type = "sound", value = Sound("Weapon_UMP_MagCheckOut")},
		
	},
	[ACT_VM_MISSCENTER2] = {
		{time = 25 / 60, type = "sound", value = Sound("Weapon_UMP_MagCheckIn")},		
	},
}
...
local SightsOffsetThingy = Vector(-0.115,0,0.875)
local SightsOffsetThingyButForAngles = Vector(-0.1,0.18,0)
...
local modrail_s_pos = Vector(0, -1, 2.9)
local modrail_ua_pos = Vector(0, -6.25, 0.08)
local modrail_ug_pos = Vector(0, -2, -0.1)
local modrail_la_pos = Vector(-0.9, -6.25, 0.96)
local modrail_lg_pos = Vector(-0.1, -2, 0)
local modrail_ra_pos = Vector(0.9, -6.25, 0.96)
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_sec.mdl", bone = "barrel", rel = "", pos = Vector(0, 1.3, 2), angle = Angle(0, 90, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = false },
