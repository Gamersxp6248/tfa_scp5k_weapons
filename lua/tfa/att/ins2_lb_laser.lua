...
ATTACHMENT.WeaponTable = {
	...
	["LaserSightAttachmentWorld"] = function(wep,stat) return wep.LaserSightModAttachmentWorld_L or wep.LaserSightModAttachment end
}
