...
ATTACHMENT.Description = { TFA.Attachments.Colors["+"], "Convert your weapon into a Big Iron", "Spread your damage and ammo across 6 shots", TFA.Attachments.Colors["-"], "High noon calls to you", "180 RPM" }
