...
ATTACHMENT.Description = { TFA.AttachmentColors["="], "8.7x zoom", TFA.AttachmentColors["-"], "40% higher zoom time",  TFA.AttachmentColors["-"], "10% slower aimed walking", "The scope WILL hit you in the face" }
...
ATTACHMENT.WeaponTable = {
	...
	["Primary"] = {
		["KickUp"] = function(wep,stat) return stat * 100 end,
		["KickDown"] = function(wep,stat) return stat * 100 end,
	},
	["Secondary"] = {
